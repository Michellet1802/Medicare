...
import com.example.medicare.AsignarConsultaFrag;
import com.example.medicare.HopitalizacionFrag;
...
public class SectionsPagerAdapterMF extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        {
            case 0 :
                return new HopitalizacionFrag();
            case 1 :
                return new AsignarConsultaFrag();
            default:
                return null;
        }
    }
